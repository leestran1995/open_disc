...
func (s MessageService) Create(ctx context.Context, request *domain.MessageCreateRequest, username string) (*domain.Message, error) {
...
func (s MessageService) GetMessagesByTimestamp(ctx context.Context, roomId uuid.UUID, timestamp time.Time) ([]*domain.Message, error) {
